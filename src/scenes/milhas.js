...
const milhasScene = new WizardScene(
    ...
    async (ctx) => {
        ...
        if (programa.toLowerCase().includes("esfera".toLowerCase()) || programa.toLowerCase().includes("livelo".toLowerCase()) || programa.toLowerCase().includes("iupi".toLowerCase()) || programa.toLowerCase().includes("carbon".toLowerCase())) {            if (/^(n[aã]o)$/i.test(obs)) {
